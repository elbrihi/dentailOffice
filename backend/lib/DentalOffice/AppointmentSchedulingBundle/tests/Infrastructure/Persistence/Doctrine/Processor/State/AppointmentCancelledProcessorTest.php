...
use DentalOffice\AppointmentSchedulingBundle\Presentation\Api\Processor\State\AppointmentCancelledProcessor;
use DentalOffice\PatientBundle\Domain\Entity\Patient;
use DentalOffice\UserBundle\Domain\Entity\User;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Security\Core\Authentication\Token\UsernamePasswordToken;

class AppointmentCancelledProcessorTest extends AppointmentProcessorTest
{

   private const CANCELLED = 'cancelled';
   public function test_it_is_cancelled()
   {
        $this-> savePatient1();
        ...
        $processor = static::getContainer()->get(AppointmentCancelledProcessor::class);
        ...
        $this->assertSame($status,self::CANCELLED);
